...
{
    // servo_position1=(msg.position[0]+1.508)/3.1415926*2047+2047;
    // // servo_position1=(-msg.position[0]-0.45)/2.618*511+511;
    // servo_position2=(msg.position[1]-0.32)/3.1415926*2047+2047;
    // servo_position3=(msg.position[2]+0.60)/2.618*511+511;
    // servo_position4=(-msg.position[3]+0.62)/2.618*511+511;
    // servo_position5=(-msg.position[4]-0.42)/2.618*511+511;
    // // servo_position5=(-msg.position[4]+0.02)/2.618*511+511;
...
int main(int argc, char** argv)
{
    ...
    unsigned char cmdBuffer6[20] = {0xff, 0xff, 0x06, 0x09, 0x03, 0x2a, 0x00, 0x64, 0x01, 0x2c, 0x03, 0xff, 0xff};
